...
import com.andradahugo.myapplication.databinding.UnsplashPhotoLoadStateFooterBinding
...
class UnsplashPhotoLoadStateAdapter(private val retry: () -> Unit) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, loadState: LoadState): LoadStateViewHolder {
        val binding =
            UnsplashPhotoLoadStateFooterBinding.inflate(LayoutInflater.from(parent.context),
                parent,
                false)
